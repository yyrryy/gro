...
class Produit(models.Model):
    ...
    remise1= models.FloatField(default=None, null=True, blank=True)
    remise2= models.FloatField(default=None, null=True, blank=True)
    ...
    stocktotalfarah=models.IntegerField(default=None, null=True, blank=True)
    stockfacturefarah=models.IntegerField(default=None, null=True, blank=True)
    stocktotalorgh=models.IntegerField(default=None, null=True, blank=True)
    stockfactureorgh=models.IntegerField(default=None, null=True, blank=True)
